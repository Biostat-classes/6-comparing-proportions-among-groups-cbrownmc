...
Heart attacks are not equally distributed because, they occur more in males than expected.

#### 2

Still using the heart attack data, is survival independent of gender?

Survival is independent of gender.
...
No strong evidence that survival depends on gender under 30
but results are uncertain due to small sample size
...
Dolphin behaviors were grouped into traveling vs. not traveling to test whether traveling depends on time of day. A chi-square test of independence showed that traveling is not independent of time of day, indicating differences in behavior across periods. Post-hoc tests identified which specific times had significantly higher or lower traveling activity than expected.
